...
#include <gtk/gtk.h>
    ...
    #define GDK_WINDOW_XROOTWIN(win)                                                               \
        GDK_WINDOW_XID(gdk_screen_get_root_window(gdk_window_get_screen(win)))
...
void
gdk_x11_window_force_focus(GdkWindow *window, guint32 timestamp) {
    GdkDisplay *display;
